...
CACHE_SIZE_T int2e_breit_##X##_spinor(double_complex *out, FINT *dims, FINT *shls, \
                             FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, \
                             CINTOpt *opt, double *cache) \
{ \
...
FINT cint2e_breit_##X##_spinor(double_complex *out, FINT *shls, \
                      FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, \
                      CINTOpt *opt) \
{ \
                            ...
                            CINTbreit_func f_gaunt, CINTbreit_func f_gauge_r1, CINTbreit_func f_gauge_r2)
{
        ...
        double_complex *buf = (double_complex *)malloc(sizeof(double_complex) * nop*2);
        double_complex *buf1;
        if (dims == NULL) {
                dims = counts;
                buf1 = out;
...
CACHE_SIZE_T int2e_breit_r1p2_spinor(double_complex *out, FINT *dims, FINT *shls,
                FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt, double *cache) {
        FINT ng[] = {2, 2, 0, 1, 4, 1, 1, 1};
        CINTEnvVars envs;
        CINTinit_int2e_EnvVars(&envs, ng, shls, atm, natm, bas, nbas, env);
...
CACHE_SIZE_T int2e_breit_r2p2_spinor(double_complex *out, FINT *dims, FINT *shls,
                FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt, double *cache) {
        FINT ng[] = {2, 1, 0, 2, 4, 1, 1, 1};
        CINTEnvVars envs;
        CINTinit_int2e_EnvVars(&envs, ng, shls, atm, natm, bas, nbas, env);
