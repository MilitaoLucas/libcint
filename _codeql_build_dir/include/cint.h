...
typedef struct CINTEnvVars {
        ...
        FINT (*f_g0_2e)(double *g, double *rij, double *rkl, double cutoff, struct CINTEnvVars *envs);
        // f_g0_2d4d has different signatures for different algorithms, use void* cast
        void *f_g0_2d4d;
        void (*f_gout)(double *gout, double *g, FINT *idx, struct CINTEnvVars *envs, FINT gout_empty);
        CINTOpt *opt;
